  ...
  return (
    <div className="flex">
      ...
      <div className="ml-64 p-6 w-full max-w-3xl">
        <h1 className="text-3xl font-bold mb-6">Instrucciones</h1>

        <p className="mb-6">
          Amigos! Les cuento que estoy desarrollando una web-app para hacer quinielas con tus amigos de forma sencilla.
          La idea es que puedas entrar a la página, ingresar tus pronósticos, y que la app descargue automáticamente los
          resultados de los partidos para calcular los puntos.
        </p>
        ...
        <p className="mb-6">
          Por eso, quería pedirles su ayuda para ser alpha-testers y jugar una pequeña quiniela con los partidos que quedan del
          Mundial de Clubes.
        </p>

        <p className="mb-6">
          Para participar, solo tienen que entrar a 👉 <a href="https://quiniela-frontend.onrender.com/" className="text-blue-600 underline">https://quiniela-frontend.onrender.com/</a>, registrarse, y luego iniciar sesión para ingresar sus pronósticos en la sección “Partidos”.
        </p>

        <p className="mb-6">
          Y para hacerlo un poquito más interesante, el ganador de la quiniela se llevará <strong>$50 USD</strong> de premio 🤑 (siempre y cuando den su feedback,
          y como el presupuesto es limitado, si hay varios ganadores tendrán que repartirlo 😅).
        </p>

        <hr className="my-6" />

        <h2 className="text-xl font-semibold mb-2">📝 Algunas consideraciones:</h2>
        <ul className="list-disc list-inside space-y-2 mb-6">
          ...
          <li>Los resultados de los partidos (y por lo tanto los puntos de la quiniela) se actualizan una vez al día.</li>
          ...
          <li>Por esa misma razón, no inviten a más gente por ahora.</li>
          <li>La app fue diseñada en computadora, así que en el celular (especialmente en vertical) se ve fea 😅 (aún más).</li>
        ...
        <h2 className="text-xl font-semibold mb-2">🙏 Me ayudaría mucho si pudieran compartir:</h2>
